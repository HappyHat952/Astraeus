...
public abstract class SpaceTreesUnit extends Unit {
	...
	public static void setGroupSize(int group_size) {
		groupSize = group_size;
	}

	public static Point getCustomRallyPoint(int i) {
		return new Point(rallyPoint.getX(), rallyPoint.getY() + (float) spreadValue * i);
	}

	public static Point getEnemyFighter() {
		return eFighter;
	}

	public static Point getAllyBuilder() {
		return aBuilder;
	}
