...
public class EnemyAnalysis {
    ...
    public static void analyzePlayer() {
        ...
        avgFighterLocation = getMedianLocation(allFighterUnits);
...
//        }
    ...
    private static Point getMedianLocation (ArrayList <Unit> list) {
        ...
        for (Unit u : list) {
            ...
            // setup sequential x
            if (xList.isEmpty() && !u.equals(player.getMyBase())) {
                xList.add(u.getX());
            }
            //sequential sort
            else {
            ...
            // setup sequential y
            if (yList.isEmpty() && !u.equals(player.getMyBase())) {
                yList.add(u.getY());
            }
        ...
        System.out.println("x |"+ xList.size()+": ");
        for (Float x:xList)
        {
            System.out.print(x+ ", ");
        }
        System.out.println("y |"+ xList.size()+": ");
        for (Float x:xList)
        {
            System.out.print(x+ ", ");
        }
